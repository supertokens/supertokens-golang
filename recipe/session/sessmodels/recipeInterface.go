...
type RecipeInterface struct {
	CreateNewSession            *func(req *http.Request, res http.ResponseWriter, userID string, accessTokenPayload map[string]interface{}, sessionDataInDatabase map[string]interface{}, useDynamicAccessTokenSigningKey *bool, userContext supertokens.UserContext) (SessionContainer, error)
