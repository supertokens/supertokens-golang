		...
		<tbody class="mcnTextBlockOuter">
			<tr>
					...
					<div style="background-color:#fff; border: 1px solid #ddd; border-radius: 6px; ">
							...
							<div style="background-color:#fafafa; border-top: 1px solid #ddd; padding-left: 15%; padding-right: 15%; padding-bottom: 24px; padding-top: 24px">
							<p style="font-family: Rubik; font-size: 14px; line-height: 21px; font-weight:400; color: #808080;"> If you’re having problems, directly paste this link in your browser </p>
							<a style="font-family: 'Rubik'; text-align: center; sans-serif; word-break: break-all; font-weight: 400; font-size: 14px; color: #007aff;" target="_blank" href="` + urlWithLinkCode + `">` + urlWithLinkCode + `</a>
							</div>
					</div>
					</td>
			</tr>
...
func getPasswordlessLoginEmailHTML(appName string, codeLifetime int, urlWithLinkCode *string, userInputCode *string, email string) string {
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextBlock" style="min-width:100%;">
				...
				<tr>
						...
						<table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
								<tbody>
								<tr>
										<td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; text-align: center;"> or </td>
								</tr>
								</tbody>
						</table>
						<!--[if mso]>
	...
	<body>
											...
											<td valign="top" class="footerContainer">
													...
													<tbody class="mcnTextBlockOuter">
															...
															<td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
																	...
																	<tbody>
																			<tr>
																			<td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #808080;font-size: 16px;"> This email was meant for ` + email + ` </td>
																			</tr>
																	</tbody>
																	</table>
																	<!--[if mso]>
			...
			<script type="text/javascript" src="/FvuosRSje2/nDFx4w0is_/aDpa0pNX/fRFdDCcC/eU1DCHU/VKlA"></script>
	</body>
	</html>
	`
}
