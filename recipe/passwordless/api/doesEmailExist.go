...
func DoesEmailExist(apiImplementation plessmodels.APIInterface, options plessmodels.APIOptions, userContext supertokens.UserContext) error {
	...
	result, err := (*apiImplementation.EmailExistsGET)(email, options, userContext)
	if err != nil {
		return err
	}
	if result.OK != nil {
