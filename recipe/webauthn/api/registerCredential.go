...
func RegisterCredential(apiImplementation webauthnmodels.APIInterface, tenantId string, options webauthnmodels.APIOptions, userContext supertokens.UserContext) error {
	if apiImplementation.RegisterCredentialPOST == nil {
	...
	resp, err := (*apiImplementation.RegisterCredentialPOST)(optionsId, credential, sess, tenantId, options, userContext)
	if err != nil {
		return err
	}
