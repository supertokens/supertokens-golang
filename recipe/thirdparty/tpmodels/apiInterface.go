...
type APIInterface struct {
	AuthorisationUrlGET *func(provider TypeProviderInterface, clientType *string, tenantId *string, redirectURIOnProviderDashboard string, options APIOptions, userContext supertokens.UserContext) (AuthorisationUrlGETResponse, error)
	SignInUpPOST        *func(provider TypeProviderInterface, clientType *string, tenantId *string, input TypeSignInUpInput, options APIOptions, userContext supertokens.UserContext) (SignInUpPOSTResponse, error)
