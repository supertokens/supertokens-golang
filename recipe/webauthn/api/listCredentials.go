...
func ListCredentials(apiImplementation webauthnmodels.APIInterface, tenantId string, options webauthnmodels.APIOptions, userContext supertokens.UserContext) error {
	if apiImplementation.ListCredentialsGET == nil {
	...
	resp, err := (*apiImplementation.ListCredentialsGET)(sess, tenantId, options, userContext)
	if err != nil {
		return err
	}
	...
	if resp.OK != nil {
		return supertokens.Send200Response(options.Res, map[string]interface{}{
			"status":      "OK",
			"credentials": resp.OK.Credentials,
		})
	}
