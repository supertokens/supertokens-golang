...
func TestWithThirdPartyPasswordlessForThirdPartyUserThatIsEmailVerifiedReturnsTheCorrectEmailVerificationStatus(t *testing.T) {
	...
	resp, err := ThirdPartyCreateOrUpdateUser("custom", "verifiedUser", "test@example.com")
	...
	resp1, err := ThirdPartyCreateOrUpdateUser("custom2", "NotVerifiedUser", "test@example.com")
	assert.NoError(t, err)
