...
func getPasswordResetEmailHTML(appName string, email string, resetLink string) string {
    ...
    <p style="font-family: Rubik; font-size: 16px; line-height: 26px; font-weight:500; text-align: center; padding-top: 24px; padding-bottom: 24px; padding-left: 10%; padding-right: 10%; ">A password reset request for your account on ` + appName + ` has been received.</p>
    ...
    <a class="button-a button-a-primary" href="` + resetLink + `" target="_blank" style="background: #52B56E;font-size: 17px;line-height: 24px;font-weight: 500;font-family: 'Rubik', sans-serif;text-decoration: none;padding: 9px 25px 9px 25px;color: #ffffff;display: block;border-radius: 6px;">Reset Password</a>
    </div>
    </div>
    </div>
