...
type RecipeInterface struct {
	...
	UpdateEmailOrPassword    *func(userId string, email *string, password *string, tenantId *string, userContext supertokens.UserContext) (epmodels.UpdateEmailOrPasswordResponse, error)
}
