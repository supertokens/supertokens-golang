...
func EmailExists(apiImplementation webauthnmodels.APIInterface, tenantId string, options webauthnmodels.APIOptions, userContext supertokens.UserContext) error {
	...
	resp, err := (*apiImplementation.EmailExistsGET)(email, tenantId, options, userContext)
	if err != nil {
		return err
	}
