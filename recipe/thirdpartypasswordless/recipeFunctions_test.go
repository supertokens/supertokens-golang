...
func TestWithThirdPartyPasswordlessForThirdPartyUserThatIsEmailVerifiedReturnsTheCorrectEmailVerificationStatus(t *testing.T) {
	...
	resp, err := ThirdPartySignInUp("custom", "verifiedUser", "test@example.com", tpmodels.TypeResponsesFromProvider{})
	...
	resp1, err := ThirdPartySignInUp("custom2", "NotVerifiedUser", "test@example.com", tpmodels.TypeResponsesFromProvider{})
	assert.NoError(t, err)
