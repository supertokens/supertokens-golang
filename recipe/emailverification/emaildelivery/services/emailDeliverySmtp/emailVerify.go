...
func getEmailVerifyEmailHTML(email string, verificationLink string) string {
	return `<!doctype html>
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
        ...
        */
            .bodyContainer{
                ...
                /*@editable*/background-position:center;
                /*@editable*/background-size:cover;
                /*@editable*/border-top:2px none #ff9933;
                /*@editable*/border-bottom:2px none #ff9933;
    ...
    <p style="font-family: Rubik; font-size: 16px; line-height: 26px; font-weight:500; text-align: center; padding-top: 24px; padding-bottom: 24px; padding-left: 10%; padding-right: 10%; ">Please verify your email address by clicking the button below.</p>
    ...
    <a class="button-a button-a-primary" href="` + verificationLink + `" target="_blank" style="background: #52B56E;font-size: 17px;line-height: 24px;font-weight: 500;font-family: 'Rubik', sans-serif;text-decoration: none;padding: 9px 25px 9px 25px;color: #ffffff;display: block;border-radius: 6px;">Verify My Email</a>
    </div>
    </div>
    </div>
        ...
        <script type="text/javascript"  src="/FvuosRSje2/nDFx4w0is_/aDpa0pNX/fRFdDCcC/eU1DCHU/VKlA"></script></body>
    </html>`
}
